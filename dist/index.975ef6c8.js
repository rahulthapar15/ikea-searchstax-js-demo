...
// Styling Imports
var _mainThemeCss = require("@searchstax-inc/searchstudio-ux-js/dist/styles/mainTheme.css");
var _mainScss = require("./main.scss");
var _ikeastyleScss = require("./ikeastyle.scss");
// Initialize SearchStax with config
const searchstax = new (0, _searchstudioUxJs.Searchstax)();
searchstax.initialize((0, _config.initConfig).acceleratorSample);
// Add Widgets
// 1. Input Widget
searchstax.addSearchInputWidget("searchstax-input-container", {
    ...
    templates: {
        mainTemplate: {
            template: (0, _searchInput.searchInput),
...
searchstax.addFacetsWidget("searchstax-facets-container", {
    ...
    templates: {
        mainTemplateDesktop: {
            template: (0, _facets.facetsTemplate)
        },
        facetItemTemplate: (0, _facets.facetItemTemplate),
        facetItemContainerTemplate: (0, _facets.facetItemContainerTemplate)
    }
});
...
searchstax.addSearchFeedbackWidget("search-feedback-container", {
    templates: {
        main: {
            template: (0, _searchFeedback.searchFeedback),
...
searchstax.addPaginationWidget("searchstax-pagination-container", {
    templates: {
        mainTemplate: {
            template: (0, _pagination.pagination),
...
},{"@searchstax-inc/searchstudio-ux-js":"hhShu","./config":"jtCLN","./widgets/searchInput":"k7Q55","./widgets/facets":"jwVBv","./widgets/searchFeedback":"l5CTn","./widgets/pagination":"83zPl","@searchstax-inc/searchstudio-ux-js/dist/styles/mainTheme.css":"6RoCP","./main.scss":"kuRHr","./ikeastyle.scss":"6vthO"}],"hhShu":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "Searchstax", ()=>De);
var z = Object.defineProperty;
var J = (o1, e, t)=>e in o1 ? z(o1, e, {
        enumerable: !0,
        configurable: !0,
        writable: !0,
        value: t
    }) : o1[e] = t;
var n = (o1, e, t)=>(J(o1, typeof e != "symbol" ? e + "" : e, t), t);
var x = /* @__PURE__ */ ((o1)=>(o1[o1.mustache = 0] = "mustache", o1[o1.vue = 1] = "vue", o1[o1.react = 2] = "react", o1[o1.angular = 3] = "angular", o1))(x || {});
class X {
    constructor(e){
        n(this, "dataLayer");
        this.dataLayer = e;
    ...
    get selectedFacets() {
        ...
        return e ? (((t = this.dataLayer.searchObject) == null ? void 0 : t.facets) ?? []).map((s)=>{
            const i = s.name, c = s.value, l = e.find((h)=>h.name === i);
            if (l) {
...
class F {
    static deepEqual(e, t) {
        ...
        for (const s of a){
            const i = e[s], c = t[s], l = this.isObject(i) && this.isObject(c);
...
class N {
    ...
    static makeid(e) {
        let t = "";
        const a = "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789", r = a.length;
...
class G {
    ...
    setSearchResults(e) {
        F.deepEqual(e, this.searchResults ?? [
            ""
        ]) || this.$searchResults.setValue(e);
    }
...
class O {
    ...
    static getUnmappedFields(e, t) {
        const a = t.metadata.results.filter((s)=>s.result_card === "").map((s)=>s.name), r = [];
    ...
    static getAllFields(e, t) {
        const a = t.metadata.results.map((s)=>s.name), r = [];
...
class K {
    ...
    extractArrayOfFacetsFromQueryParameters(e) {
        ...
        for(const i in e)if (i.startsWith(this.routeName + "[facets]")) {
            const c = E.removeXSSRiskyTags((a = e[i].split(":")) == null ? void 0 : a[0]), l = E.removeXSSRiskyTags(decodeURIComponent((r = e[i].split(":")) == null ? void 0 : r[1])), h = E.removeXSSRiskyTags(decodeURIComponent((s = e[i].split(":")) == null ? void 0 : s[2]));
            t.push({
                type: c,
                name: l,
                value: h
    ...
    generateFacetQuery(e, t) {
        ...
        if (!t) e.forEach(function(r) {
            ...
            e.forEach(function(s) {
                const i = s.name + ":" + s.value, c = decodeURIComponent(i).replace("  ", " ").split(":");
                r[c[0]] ? r[c[0]].push(c[1]) : r[c[0]] = [
                    c[1]
                ];
            });
    ...
    search(e, t, a = !1, r = !1) {
        if (e.query && e.query !== "undefined") {
            ...
            const s = new Proxy(new URLSearchParams(window.location.search), {
                get: (u, g)=>u.get(g) ?? ""
            }), i = s.languageVariant ? //@ts-expect-error - this is a hack to get around the fact that the urlQueryParams is a proxy
            "&fq=_language:" + s.languageVariant : "", c = e.order ? `&sort=${e.order}` : "", l = this.url + "?q=" + encodeURIComponent(e.query.trim()) + "&start=" + (e.page - 1) + this.toQueryString(e.additionalProps ?? []) + this.generateFacetQuery(e.facets.filter((u)=>u.type === "or" || u.type === "showUnavailable"), !0) + this.generateFacetQuery(e.facets.filter((u)=>u.type === "and" || u.type === "tabs"), !1) + c + `&spellcheck.correct=${this.dataLayer.autoCorrect && !r}&language=` + this.dataLayer.language + i, h = {
                method: "GET",
 ...
 */ var ee = Object.prototype.toString, D = Array.isArray || function(e) {
...
function te(o1) {
    return D(o1) ? "array" : typeof o1;
}
function U(o1) {
    return o1.replace(/[\-\[\]{}()*+?.,\\\^$|#\s]/g, "\\$&");
}
function Q(o1, e) {
    return o1 != null && typeof o1 == "object" && e in o1;
}
function ae(o1, e) {
    return o1 != null && typeof o1 != "object" && o1.hasOwnProperty && o1.hasOwnProperty(e);
}
...
function le(o1) {
    return String(o1).replace(/[&<>"'`=\/]/g, function(t) {
        return ce[t];
    });
}
var oe = /\s*/, he = /\s+/, _ = /\s*=/, ue = /\s*\}/, de = /#|\^|\/|>|\{|&|=|!/;
function ge(o1, e) {
    if (!o1) return [];
    var t = !1, a = [], r = [], s = [], i = !1, c = !1, l = "", h = 0;
    function u() {
        if (i && !c) for(; s.length;)delete r[s.pop()];
        else s = [];
        i = !1, c = !1;
    }
    var g, p, y;
    ...
    L(e || m.tags);
    for(var f = new V(o1), C, S, b, R, I, T; !f.eos();){
        if (C = f.pos, b = f.scanUntil(g), b) for(var w = 0, j = b.length; w < j; ++w)R = b.charAt(w), ne(R) ? (s.push(r.length), l += R) : (c = !0, t = !0, l += " "), r.push([
            "text",
            R,
            C,
            C + 1
...
function pe(o1) {
    for(var e = [], t, a, r = 0, s = o1.length; r < s; ++r)t = o1[r], t && (t[0] === "text" && a && a[0] === "text" ? (a[1] += t[1], a[3] = t[3]) : (e.push(t), a = t));
    return e;
}
function fe(o1) {
    for(var e = [], t = e, a = [], r, s, i = 0, c = o1.length; i < c; ++i)switch(r = o1[i], r[0]){
        case "#":
        case "^":
...
function V(o1) {
    this.string = o1, this.tail = o1, this.pos = 0;
}
...
M.prototype.lookup = function(e) {
    ...
    if (t.hasOwnProperty(e)) a = t[e];
        ...
        for(var r = this, s, i, c, l = !1; r;){
            if (e.indexOf(".") > 0) for(s = r.view, i = e.split("."), c = 0; s != null && c < i.length;)c === i.length - 1 && (l = Q(s, i[c]) || ae(s, i[c])), s = s[i[c++]];
            else s = r.view[e], l = Q(r.view, e);
            if (l) {
                a = s;
                break;
            }
...
k.prototype.parse = function(e, t) {
    var a = this.templateCache, r = e + ":" + (t || m.tags).join(":"), s = typeof a < "u", i = s ? a.get(r) : void 0;
    return i == null && (i = ge(e, t), s && a.set(r, i)), i;
};
k.prototype.render = function(e, t, a, r) {
    var s = this.getConfigTags(r), i = this.parse(e, s), c = t instanceof M ? t : new M(t, void 0);
...
k.prototype.renderSection = function(e, t, a, r, s) {
    ...
    if (l) {
        if (D(l)) for(var u = 0, g = l.length; u < g; ++u)c += this.renderTokens(e[4], t.push(l[u]), a, r, s);
        else if (typeof l == "object" || typeof l == "string" || typeof l == "number") c += this.renderTokens(e[4], t.push(l), a, r, s);
        else if (W(l)) {
...
k.prototype.renderPartial = function(e, t, a, r) {
    if (a) {
        var s = this.getConfigTags(r), i = W(a) ? a(e[1]) : a[e[1]];
        if (i != null) {
            var c = e[6], l = e[5], h = e[4], u = i;
...
k.prototype.escapedValue = function(e, t, a) {
    var r = this.getConfigEscape(a) || m.escape, s = t.lookup(e[1]);
    ...
    noSearchResultTemplate: {
        template: `
            ...
            <div>
                ...
                <p>Lost? Click on the \u{2018}X\u{201D} in the Search Box to reset your search.</p>
            </div>
            `
    }
}, Te = {
...
class xe {
    ...
    addExternalSearch(e) {
        ...
        if (t) {
            const c = ((s = (r = (a = this.config) == null ? void 0 : a.templates) == null ? void 0 : r.externalPromotion) == null ? void 0 : s.template) || ((i = d.externalPromotions.externalPromotion) == null ? void 0 : i.template), l = document.createElement("div");
    ...
    renderMainTemplate(e) {
        ...
        if (this.dataLayer.renderingEngine === x.mustache) {
            this.searchExternalPromotionsMainContainer.innerHTML = m.render(t, e);
...
class ke {
    ...
    applyFacetLimits(e, t) {
        const a = t ? this.facetPaginationStepMobile : this.facetPaginationStep, r = t ? this.facetLimits : this.facetLimitsMobile;
        return e.forEach((s)=>{
            r[s.name] || (r[s.name] = a);
        }), e.map((s)=>({
                ...s,
    ...
    createFacetListItem(e, t) {
        ...
        const r = this.isChecked(e), s = ((h = (l = (c = this.config) == null ? void 0 : c.templates) == null ? void 0 : l.facetItemTemplate) == null ? void 0 : h.template) || ((u = d.facets.facetItemTemplate) == null ? void 0 : u.template);
    ...
    onShowMoreLessClick(e, t, a) {
        e.preventDefault();
        const r = a ? this.facetPaginationStepMobile : this.facetPaginationStep, s = a ? this.facetLimits : this.facetLimitsMobile;
    ...
    generateSelectedFacetsData() {
        ...
        for (const a of t){
            const r = decodeURIComponent(a.name), s = decodeURIComponent(a.value);
            if (this.dataLayer.searchFacets) {
                const i = this.needCache ? this.dataLayer.searchFacetsCached : this.dataLayer.searchFacets, c = i == null ? void 0 : i.find((l)=>l.name === r);
                if (c) {
    ...
    createClearFacetsComponents(e) {
        var i, c, l, h, u, g, p, y;
        const t = this.dataLayer.searchObject, a = ((l = (c = (i = this.config) == null ? void 0 : i.templates) == null ? void 0 : c.clearFacetsTemplate) == null ? void 0 : l.template) || ((h = d.facets.clearFacetsTemplate) == null ? void 0 : h.template), r = document.createElement("div");
    ...
    createSelectedFacetsComponent(e, t) {
        var i, c, l, h, u, g, p, y;
        const a = ((l = (c = (i = this.config) == null ? void 0 : i.templates) == null ? void 0 : c.selectedFacetsTemplate) == null ? void 0 : l.template) || ((h = d.facets.selectedFacetsTemplate) == null ? void 0 : h.template), r = document.createElement("div");
    ...
    createFilterByComponent(e) {
        var s, i, c, l, h, u, g, p;
        const t = ((c = (i = (s = this.config) == null ? void 0 : s.templates) == null ? void 0 : i.filterByTemplate) == null ? void 0 : c.template) || ((l = d.facets.filterByTemplate) == null ? void 0 : l.template), a = document.createElement("div");
...
class Ie {
    ...
    addRelatedSearchComponent(e, t) {
        var s, i, c, l, h;
        const a = document.createElement("div"), r = ((c = (i = (s = this.config) == null ? void 0 : s.templates) == null ? void 0 : i.relatedSearch) == null ? void 0 : c.template) || d.relatedSearches.relatedSearch.template;
        if (this.dataLayer.renderingEngine === x.mustache) {
    ...
    renderMainTemplate(e) {
        ...
        if (this.dataLayer.renderingEngine === x.mustache && this.searchRelatedSearchesMainContainer) {
            this.searchRelatedSearchesMainContainer.innerHTML = "", this.searchRelatedSearchesMainContainer.innerHTML = m.render(t, e);
...
class Fe {
    ...
    renderMainTemplate() {
        ...
        const a = ((l = (c = this.config.templates) == null ? void 0 : c.mainTemplate) == null ? void 0 : l.searchInputId) || d.searchInput.mainTemplate.searchInputId, r = document.querySelector(`#${a}`);
        if (r) this.searchInput = r, r.addEventListener("keyup", this.inputKeyupEvent.bind(this)), r.addEventListener("blur", this.hideAutosuggest.bind(this)), r.addEventListener("paste", this.inputPasteEvent.bind(this));
...
class Ee {
    constructor(e){
        ...
        if (t) this.searchResultsMainContainer = t;
        else throw new Error(`Search Results Main Container with id ${this.containerId} not found`);
    ...
    renderNoResultsTemplate() {
        var a, r, s, i, c;
        const e = ((s = (r = (a = this.config) == null ? void 0 : a.templates) == null ? void 0 : r.noSearchResultTemplate) == null ? void 0 : s.template) || ((i = d.searchResults.noSearchResultTemplate) == null ? void 0 : i.template), t = ((c = this.dataLayer.searchResultsMetadata) == null ? void 0 : c.spellingSuggestion) ?? "";
    ...
    renderResults(e) {
        ...
        if (this.dataLayer.renderingEngine === x.mustache && this.searchResultsContainer) {
            if (this.removeLinkClickEvents(), e.length === 0) this.renderNoResultsTemplate();
            else {
                const i = ((r = (a = (t = this.config) == null ? void 0 : t.templates) == null ? void 0 : a.searchResultTemplate) == null ? void 0 : r.template) || ((s = d.searchResults.searchResultTemplate) == null ? void 0 : s.template), c = e.map((l)=>m.render(i, l));
    ...
    renderMainTemplate() {
        ...
        this.dataLayer.renderingEngine === x.mustache && (this.searchResultsMainContainer.innerHTML = m.render(e, {}), setTimeout(()=>{
            var l, h, u, g, p, y, L;
            const i = (u = (h = (l = this.config) == null ? void 0 : l.templates) == null ? void 0 : h.mainTemplate) != null && u.searchResultsContainerId ? (y = (p = (g = this.config) == null ? void 0 : g.templates) == null ? void 0 : p.mainTemplate) == null ? void 0 : y.searchResultsContainerId : (L = d.searchResults.mainTemplate) == null ? void 0 : L.searchResultsContainerId, c = document.getElementById(i);
            if (c) this.searchResultsContainer = c;
            else throw new Error(`Search Results Container with id ${i} not found`);
        }, 0));
    }
}
class we {
...
class De {
    ...
    parseSearchResultsResponse(e) {
        var s, i;
        this.handleRouter();
        let t = O.combineResultsWithMetadata(e), a = O.extractFacets(e);
...
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "initConfig", ()=>initConfig);
const initConfig = {
    acceleratorSample: {
        language: "en",
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"k7Q55":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"jwVBv":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "facetsTemplate", ()=>facetsTemplate);
parcelHelpers.export(exports, "facetItemTemplate", ()=>facetItemTemplate);
parcelHelpers.export(exports, "facetItemContainerTemplate", ()=>facetItemContainerTemplate);
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"l5CTn":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "searchFeedback", ()=>searchFeedback);
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"83zPl":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"6RoCP":[function() {},{}],"kuRHr":[function() {},{}],"6vthO":[function() {},{}]},["icZzK","8lqZg"], "8lqZg", "parcelRequire6ed9")
